...
app.get('/:role', async function (request, response) {
    ...
    const messages = await fetch(`https://fdnd.directus.app/items/messages?filter={%22for%22:{%22_contains%22:%22jules-12-sprint_%22}}&sort=-created`)
